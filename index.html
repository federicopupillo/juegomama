...
<head>
    ...
    <title>Mamá Médica: Misión Buenos Aires</title>
...
<div id="game-container">
    ...
    <div id="startScreen" class="overlay">
        <h1>🏥 MAMÁ MÉDICA<br>EN BUENOS AIRES 🇦🇷</h1>
        <p>Tu nene necesita pañales... ¡y vos querés viajar!</p>
    ...
    <div id="gameOverScreen" class="overlay hidden">
        ...
        <p id="deathReason">La inflación te ganó.</p>
        <button class="action-btn" onclick="resetGame()">Probar otro mes</button>
    </div>

    <!-- Pantalla Victoria -->
    <div id="winScreen" class="overlay hidden">
        <h1 style="color: #55efc4;">¡LLEGASTE! ✅</h1>
...
<script>
    ...
    function update() {
        ...
        if (player.y > canvas.height + 100) gameOver("¡Caíste en la grieta!");
        ...
        enemies.forEach(enemy => {
            ...
            if (player.x + buffer < enemy.x + enemy.width - buffer &&
                ...
                gameOver(`¡Gasto Imprevisto: ${enemy.type.name}!`);
            }
        });
